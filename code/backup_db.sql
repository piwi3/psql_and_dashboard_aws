...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.categories OWNER TO philipwitte;

--
-- Name: customers; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.customers OWNER TO philipwitte;

--
-- Name: employees; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.employees OWNER TO philipwitte;

--
-- Name: employees_have_territories; Type: TABLE; Schema: public; Owner: philipwitte
--

CREATE TABLE public.employees_have_territories (
    employee_id integer,
    territory_id integer
);


ALTER TABLE public.employees_have_territories OWNER TO philipwitte;

--
-- Name: orders; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.orders OWNER TO philipwitte;

--
-- Name: orders_have_details; Type: TABLE; Schema: public; Owner: philipwitte
--

CREATE TABLE public.orders_have_details (
    order_id integer,
    product_id integer,
...
ALTER TABLE public.orders_have_details OWNER TO philipwitte;

--
-- Name: products; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.products OWNER TO philipwitte;

--
-- Name: regions; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.regions OWNER TO philipwitte;

--
-- Name: shippers; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.shippers OWNER TO philipwitte;

--
-- Name: suppliers; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.suppliers OWNER TO philipwitte;

--
-- Name: territories; Type: TABLE; Schema: public; Owner: philipwitte
--
...
ALTER TABLE public.territories OWNER TO philipwitte;

--
-- Data for Name: categories; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Data for Name: customers; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
1	Davolio	Nancy	Sales Representative	Ms.	1948-12-08 00:00:00.000	1992-05-01 00:00:00.000	507 20th Ave. E. Apt. 2A	Seattle	WA	98122	USA	(206) 555-9857	5467	\\x30	Education includes a BA in psychology from Colorado State University in 1970.  She also completed The Art of the Cold Call.  Nancy is a member of Toastmasters International.	2	http://accweb/emmployees/davolio.bmp
2	Fuller	Andrew	Vice President Sales	Dr.	1952-02-19 00:00:00.000	1992-08-14 00:00:00.000	908 W. Capital Way	Tacoma	WA	98401	USA	(206) 555-9482	3457	\\x30	Andrew received his BTS commercial in 1974 and a Ph.D. in international marketing from the University of Dallas in 1981.  He is fluent in French and Italian and reads German.  He joined the company as a sales representative was promoted to sales manager	\N	http://accweb/emmployees/fuller.bmp
3	Leverling	Janet	Sales Representative	Ms.	1963-08-30 00:00:00.000	1992-04-01 00:00:00.000	722 Moss Bay Blvd.	Kirkland	WA	98033	USA	(206) 555-3412	3355	\\x30	Janet has a BS degree in chemistry from Boston College (1984). She has also completed a certificate program in food retailing management.  Janet was hired as a sales associate in 1991 and promoted to sales representative in February 1992.	2	http://accweb/emmployees/leverling.bmp
...
8	Callahan	Laura	Inside Sales Coordinator	Ms.	1958-01-09 00:00:00.000	1994-03-05 00:00:00.000	4726 11th Ave. N.E.	Seattle	WA	98105	USA	(206) 555-1189	2344	\\x30	Laura received a BA in psychology from the University of Washington.  She has also completed a course in business French.  She reads and writes French.	2	http://accweb/emmployees/davolio.bmp
...
--
-- Data for Name: employees_have_territories; Type: TABLE DATA; Schema: public; Owner: philipwitte
--

COPY public.employees_have_territories (employee_id, territory_id) FROM stdin;
1	6897
1	19713
2	1581
2	1730
...
--
-- Data for Name: orders; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Data for Name: orders_have_details; Type: TABLE DATA; Schema: public; Owner: philipwitte
--

COPY public.orders_have_details (order_id, product_id, unit_price, quantity, discount) FROM stdin;
10248	11	14	12	0
10248	42	9.8	10	0
10248	72	34.8	5	0
10249	14	18.6	9	0
...
--
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Data for Name: regions; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Data for Name: shippers; Type: TABLE DATA; Schema: public; Owner: philipwitte
--

COPY public.shippers (shipperid, company_name, phone) FROM stdin;
...
--
-- Data for Name: suppliers; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Data for Name: territories; Type: TABLE DATA; Schema: public; Owner: philipwitte
--
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: customers customers_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: employees employees_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: orders orders_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: products products_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: regions regions_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: shippers shippers_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: suppliers suppliers_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
...
--
-- Name: territories territories_pkey; Type: CONSTRAINT; Schema: public; Owner: philipwitte
--
